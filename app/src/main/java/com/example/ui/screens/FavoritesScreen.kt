            ...
            if (favorites.isEmpty()) {
                Box(
                    ...
                    Column(
                        ...
                        modifier = Modifier.testTag("favorites_empty_state")
                    ) {
                        Icon(
                        ...
                        Text(
                            text = "Browse modern walls, tap the heart icon on any detail page to back them up here instantly.",
                            fontSize = 13.sp,
